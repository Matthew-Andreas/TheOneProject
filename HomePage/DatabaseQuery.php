...
class DatabaseQuery{
    ...
    public $checkBoxValues = ["Free" => "Free_or_Paid","Paid" => "Free_or_Paid",
                                ...
                                "Finacial_Information" => "Topic_of_Resource_Header", "Investment_Advisor" => "Topic_of_Resource", "Education_FL_BP_BC" => "Topic_of_Resource", "Wealth_Managment" => "Topic_of_Resource", "Accounting_Assistance" => "Topic_of_Resource", "Banking" => "Topic_of_Resource", 
