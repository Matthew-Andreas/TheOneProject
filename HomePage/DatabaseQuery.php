...
class DatabaseQuery{
    ...
    public $checkBoxValues = ["Free" => "Free_or_Paid","Paid" => "Free_or_Paid",
                                ...
                                "Microenterprise" => "Type_of_Business", "Innovation_Tech" => "Type_of_Business", "Main_Street" => "Type_of_Business", "Medium_Large_Business" => "Type_of_Business", "Pop_Ups_Venders" => "Type_of_Business",
                                ...
                                "Funding" => "Topic_of_Resource_Header", "Funding_Venture_Capital" => "Topic_of_Resource", "Private_Equity_Firms" => "Topic_of_Resource", "Funding_Angel" => "Topic_of_Resource", "Grant" => "Topic_of_Resource", "Loans" => "Topic_of_Resource", "Crowdfunding" => "Topic_of_Resource", "Microcredit_Microloans" => "Topic_of_Resource", "Other_Funding" => "Topic_of_Resource", 
                                "Financial_Information" => "Topic_of_Resource_Header", "Investment_Advisor" => "Topic_of_Resource", "Education_FL_BP_BC" => "Topic_of_Resource", "Wealth_Management" => "Topic_of_Resource", "Accounting_Assistance" => "Topic_of_Resource", "Banking" => "Topic_of_Resource", 
                                ...
                                "Tech_Assistance" => "Topic_of_Resource_Header", "Tech_Help" => "Topic_of_Resource", "Project_Management_Software" => "Topic_of_Resource", "Website_Assistance" => "Topic_of_Resource", "Software" => "Topic_of_Resource", "Mobile_n_Web_App_Development" => "Topic_of_Resource", "Mobile_Form_Development" => "Topic_of_Resource", "Cyber_Security" => "Topic_of_Resource", "Website_Builder" => "Topic_of_Resource", "Software_Development" => "Topic_of_Resource", 
                                ...
                                "Legal_Assistance" => "Topic_of_Resource_Header", "General_Legal_Assistance" => "Topic_of_Resource", "Legal_Assistance_IP_TM_P" => "Topic_of_Resource", "Legal_Assistance_Legal_Formation" => "Topic_of_Resource"
                            ];
